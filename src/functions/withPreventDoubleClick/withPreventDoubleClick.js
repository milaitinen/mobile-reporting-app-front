...
const withPreventDoubleClick = (WrappedComponent) => {
    ...
    class PreventDoubleClick extends React.PureComponent {
        ...
        debouncedOnPress = () => {
            // Short circuit evaluation (if this.props.onPress is true) && (this.props.onPress() will execute)
            this.props.onPress && this.props.onPress();
        };
        // Debounce onPress if already pressed during 600ms.
        onPress = debounce(this.debouncedOnPress, 600, { leading: true, trailing: false });
